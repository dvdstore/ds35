...
<?php
/*  
 * DVD Store Review Helpfulness Rating PHP Postgresql Page - dsnewrevuew.php
 *
 ...
 * Updates are made to the postgresql REVIEWS_HELPFULNESS table via a stored procedure
 *
...
if (!(empty($reviewid) OR empty($review_helpfulness)))
  ...
  pg_free_result($get_review_esult);
