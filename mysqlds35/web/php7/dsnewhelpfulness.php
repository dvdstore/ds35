...
if (!(empty($reviewid) OR empty($review_helpfulness)))
  ...
  $new_helpfulness_proc_call = "call DS3.NEW_REVIEW_HELPFULNESS$storenum(" .
  ...
  $get_review_result = mysqli_query($link_id,$get_review_query);
  $get_review_result_row = mysqli_fetch_row($get_review_result);
  echo "----------------------------------------------------------------------------------------------<BR>";
  ...
  mysqli_free_result($get_review_esult);
