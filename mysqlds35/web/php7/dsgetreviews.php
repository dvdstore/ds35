...
if (!empty($getreviewtype))
  ...
  $getreviews_result = mysqli_query($link_id,$getreview_query);

  if (mysqli_num_rows($getreviews_result) == 0)
    {
    ...
    while ($getreviews_result_row = mysqli_fetch_row($getreviews_result))
      {
      echo "----------------------------------------------------------------------------------------------<BR>";
    ...
    mysqli_free_result($getreviews_result);
