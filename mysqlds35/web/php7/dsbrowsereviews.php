...
if (!empty($browsereviewtype))
  ...
  $browsereviews_result = mysqli_query($link_id,$browsereview_query);

  if (mysqli_num_rows($browsereviews_result) == 0)
    {
    ...
    while ($browsereviews_result_row = mysqli_fetch_row($browsereviews_result))
      {
      echo "----------------------------------------------------------------------------------------------<BR>";
    ...
    mysqli_free_result($browsereviews_result);
