# mysqlds3_perl_cleanup_multi.pl
# Script to cleanup or reset ds35 tables in MySQL with a provided number of copies - supporting multiple stores
# Syntax to run - perl mysqlds3_perl_cleanup_multi.pl <mysql_target> <number_of_stores> <DB Size - example 10GB >
...
$i_Review_Rows = $par_n_Prod * $par_Avg_Reviews;
...
delete from REVIEWS$k where REVIEWID > $i_Review_Rows;
delete from REVIEWS_HELPFULNESS where REVIEWID > $i_Review_Rows;
