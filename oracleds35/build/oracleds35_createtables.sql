...
CREATE TABLE "DS3"."REVIEWS_HELPFULNESS5"
  (
...
CREATE TABLE "DS3"."CATEGORIES5"
  (
  "CATEGORY" NUMBER NOT NULL, 
  "CATEGORYNAME" VARCHAR2(50 byte) NOT NULL, 
  CONSTRAINT "PK_CATEGORIES5" PRIMARY KEY("CATEGORY")
  )
  ;

  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (1,'Action');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (2,'Animation');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (3,'Children');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (4,'Classics');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (5,'Comedy');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (6,'Documentary');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (7,'Drama');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (8,'Family');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (9,'Foreign');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (10,'Games');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (11,'Horror');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (12,'Music');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (13,'New');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (14,'Sci-Fi');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (15,'Sports');
  INSERT INTO "DS3"."CATEGORIES5" (CATEGORY, CATEGORYNAME) VALUES (16,'Travel');


CREATE TABLE "DS3"."REORDER5" 
  (
  "PROD_ID" NUMBER NOT NULL, 
...
CREATE SEQUENCE "DS3"."CUSTOMERID_SEQ5" 
  INCREMENT BY 1 
  START WITH 20000001
  MAXVALUE 1.0E28 
  MINVALUE 1 
...
CREATE SEQUENCE "DS3"."ORDERID_SEQ5" 
  INCREMENT BY 1 
  START WITH 20000001 
  MAXVALUE 1.0E28 
  MINVALUE 1 
