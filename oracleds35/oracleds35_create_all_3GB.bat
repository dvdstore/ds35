...
sqlplus "sys/oracle@%1 as sysdba" @oracleds35_create_tablespaces_3GB.sql
perl oracleds35_perl_create_db_tables_multi.pl %1 %2
REM perl oracleds35_perl_create_db_tables_multi3GB.pl %1 %2
