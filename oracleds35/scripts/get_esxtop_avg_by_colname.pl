...
# Script to parse an esxtop file and provide the averages for all columns that match the input string
# Syntax to run - perl ds3_esxtop_avg_by_col_name.pl <esxtop_file_to_be_parsed> <string to match> 
...
$searchstring = $ARGV[1];
$outputcsv = $title . $searchstring . 'col.csv';
