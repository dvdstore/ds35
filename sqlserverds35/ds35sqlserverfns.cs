...
/*
 * DVD Store 3.5 SQL Server Functions - ds35sqlserverfns.cs
 *
...
//  
    public bool ds2connect()
      ...
      Login = new SqlCommand("LOGIN" + target_store_number, objConn);
      ...
      New_Member = new SqlCommand("NEW_MEMBER" + target_store_number, objConn);
      ...
      New_Prod_Review = new SqlCommand("NEW_PROD_REVIEW" + target_store_number, objConn);
      ...
      Get_Prod_Reviews_By_Date = new SqlCommand("GET_PROD_REVIEWS_BY_DATE" + target_store_number, objConn);
      ...
      Get_Prod_Reviews_By_Stars = new SqlCommand("GET_PROD_REVIEWS_BY_STARS" + target_store_number, objConn);
