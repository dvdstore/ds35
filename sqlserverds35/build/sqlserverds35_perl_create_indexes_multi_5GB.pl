...
# Syntax to run - perl sqlserverds3_perl_create_indexes_multi.pl <sqlserver_target> <number_of_stores> 
...
EXEC sp_fulltext_catalog  'FULLTEXTCAT_DSPROD$k', 'create', 'c:\\dbfiles\\'
EXEC sp_fulltext_table    'PRODUCTS$k',           'create', 'FULLTEXTCAT_DSPROD$k', 'PK_PRODUCTS$k'
EXEC sp_fulltext_column   'PRODUCTS$k',           'ACTOR', 'add'
EXEC sp_fulltext_column   'PRODUCTS$k',           'TITLE', 'add'
EXEC sp_fulltext_table    'PRODUCTS$k',           'activate'
EXEC sp_fulltext_catalog  'FULLTEXTCAT_DSPROD$k', 'start_full'
GO
