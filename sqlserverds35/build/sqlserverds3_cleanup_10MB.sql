...
delete from REORDER 
go
delete from CUSTOMERS where CUSTOMERID > 20000     --This placeholder will be replaced by perl script with the paths given by user
go
...
go
delete from REVIEWS where REVIEWS > 200000
go
dbcc checkident('CUSTOMERS', RESEED, 20000)
go
dbcc checkident('CUSTOMERS', NORESEED)
go
dbcc checkident('ORDERS', RESEED, 12000)
go
dbcc checkident('ORDERS', NORESEED)
go
dbcc checkident('REVIEWS', RESEED, 200000
go
