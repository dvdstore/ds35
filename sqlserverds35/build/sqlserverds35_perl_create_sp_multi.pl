...
# Syntax to run - perl sqlserverds3_perl_create_sp_multi.pl <sqlserver_target> <number_of_stores> 
...
foreach my $k (1 .. $numberofstores){
	open (my $OUT, ">sqlserverds3_createsp$k.sql") || die("Can't open sqlserverds3_createsp$k.sql");
...
AS (SELECT TOP (500) PRODUCTS$k.TITLE, PRODUCTS$k.ACTOR, PRODUCTS$k.PROD_ID, REVIEWS$k.REVIEW_DATE, REVIEWS$k.STARS, REVIEWS$k.REVIEW_ID,
...
sleep (1);
  ...
  system ("start sqlcmd -S $sqlservertarget -U sa -P password -i sqlserverds3_createsp$k.sql");
  }
  system ("sqlcmd -S $sqlservertarget -U sa -P password -i sqlserverds3_createsp$numberofstores.sql");
