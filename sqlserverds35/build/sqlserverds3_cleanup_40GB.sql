...
delete from REORDER 
go
delete from CUSTOMERS where CUSTOMERID > 80000000     --This placeholder will be replaced by perl script with the paths given by user
go
delete from ORDERS where ORDERID > 48000000
go
delete from ORDERLINES where ORDERID > 48000000
go
delete from CUST_HIST where ORDERID > 48000000
go
delete from REVIEWS where REVIEWS > 8000000
go
dbcc checkident('CUSTOMERS', RESEED, 80000000)
go
dbcc checkident('CUSTOMERS', NORESEED)
go
dbcc checkident('ORDERS', RESEED, 48000000)
go
dbcc checkident('ORDERS', NORESEED)
go
dbcc checkident('REVIEWS', RESEED, 8000000
go
