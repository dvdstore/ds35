...
delete from REORDER 
go
delete from CUSTOMERS where CUSTOMERID > 4000     --This placeholder will be replaced by perl script with the paths given by user
go
delete from ORDERS where ORDERID > 2400
go
delete from ORDERLINES where ORDERID > 2400
go
delete from CUST_HIST where ORDERID > 2400
go
delete from REVIEWS where REVIEWS > 40000
go
dbcc checkident('CUSTOMERS', RESEED, 4000)
go
dbcc checkident('CUSTOMERS', NORESEED)
go
dbcc checkident('ORDERS', RESEED, 2400)
go
dbcc checkident('ORDERS', NORESEED)
go
dbcc checkident('REVIEWS', RESEED, 40000
go
