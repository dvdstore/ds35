...
delete from REORDER 
go
delete from CUSTOMERS where CUSTOMERID > 20000000     --This placeholder will be replaced by perl script with the paths given by user
go
delete from ORDERS where ORDERID > 12000000
go
delete from ORDERLINES where ORDERID > 12000000
go
delete from CUST_HIST where ORDERID > 12000000
go
delete from REVIEWS where REVIEWS > 2000000
go
dbcc checkident('CUSTOMERS', RESEED, 20000000)
go
dbcc checkident('CUSTOMERS', NORESEED)
go
dbcc checkident('ORDERS', RESEED, 12000000)
go
