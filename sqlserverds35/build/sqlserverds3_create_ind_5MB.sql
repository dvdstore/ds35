...
EXEC sp_fulltext_catalog  'FULLTEXTCAT_DSPROD', 'create', 'c:\sql\dbfiles'     --Added a placeholder by GSK --This placeholder will be replaced by perl script with the paths given by user
