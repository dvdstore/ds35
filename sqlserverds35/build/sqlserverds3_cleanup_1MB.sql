...
delete from REORDER 
go
delete from CUSTOMERS where CUSTOMERID > 2000     --This placeholder will be replaced by perl script with the paths given by user
go
delete from ORDERS where ORDERID > 1200
go
delete from ORDERLINES where ORDERID > 1200
go
delete from CUST_HIST where ORDERID > 1200
go
delete from REVIEWS where REVIEWS > 20000
go
dbcc checkident('CUSTOMERS', RESEED, 2000)
go
dbcc checkident('CUSTOMERS', NORESEED)
go
dbcc checkident('ORDERS', RESEED, 1200)
go
dbcc checkident('ORDERS', NORESEED)
go
dbcc checkident('REVIEWS', RESEED, 20000
go
