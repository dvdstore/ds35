...
delete from REORDER 
go
delete from CUSTOMERS where CUSTOMERID > 10000     --This placeholder will be replaced by perl script with the paths given by user
go
delete from ORDERS where ORDERID > 6000
go
delete from ORDERLINES where ORDERID > 6000
go
delete from CUST_HIST where ORDERID > 6000
go
delete from REVIEWS where REVIEWS > 100000
go
dbcc checkident('CUSTOMERS', RESEED, 10000)
go
dbcc checkident('CUSTOMERS', NORESEED)
go
dbcc checkident('ORDERS', RESEED, 6000)
go
dbcc checkident('ORDERS', NORESEED)
go
dbcc checkident('REVIEWS', RESEED, 100000
go
