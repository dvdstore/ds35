...
delete from REORDER 
go
delete from CUSTOMERS where CUSTOMERID > 100000     --This placeholder will be replaced by perl script with the paths given by user
go
delete from ORDERS where ORDERID > 60000
go
delete from ORDERLINES where ORDERID > 60000
go
delete from CUST_HIST where ORDERID > 60000
go
delete from REVIEWS where REVIEWS > 1000000
go
dbcc checkident('CUSTOMERS', RESEED, 100000)
go
dbcc checkident('CUSTOMERS', NORESEED)
go
dbcc checkident('ORDERS', RESEED, 60000)
go
