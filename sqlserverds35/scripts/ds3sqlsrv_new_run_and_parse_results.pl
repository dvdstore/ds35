...
foreach my $i (0 .. $#threads_list) {
  ...
  #driver 2 for instance 1	
	print  "start cmd /c ds35sqlserverdriver.exe --config_file=param1.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}2.csv\n"; 
    system("start cmd /c ds35sqlserverdriver.exe --config_file=param1.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}2.csv");
...
#driver 4 for instance 2	
	print  "start cmd /c ds35sqlserverdriver.exe --config_file=param2.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}4.csv\n"; 
    system("start cmd /c ds35sqlserverdriver.exe --config_file=param2.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}4.csv");
...
#driver 6 for instance 3	
	print  "start cmd /c ds35sqlserverdriver.exe --config_file=param3.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}6.csv\n"; 
    system("start cmd /c ds35sqlserverdriver.exe --config_file=param3.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}6.csv");
  ...
  print "ds35sqlserverdriver.exe --config_file=param4.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}${num_drivers}.csv --windows_perf_host=$ds3_target\n";
  `ds35sqlserverdriver.exe --config_file=param4.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}8.csv --windows_perf_host=$ds3_target`;
