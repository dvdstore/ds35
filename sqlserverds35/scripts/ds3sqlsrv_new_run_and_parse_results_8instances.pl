...
#my @threads_list = (20,22,24,26,28);
#my @threads_list = (8,10,12,14,16);
my @threads_list = (6,8,10,12,14);
my $num_drivers = 2;
my $ds3_target = "10.133.255.59";
my $esx_target = "w1-outperf25.eng.vmware.com";
...
foreach my $i (0 .. $#threads_list) {
  ...
  #driver 2 for instance 1	
	#print  "start cmd /c ds35sqlserverdriver.exe --config_file=param2.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}2.csv\n"; 
    #system("start cmd /c ds35sqlserverdriver.exe --config_file=param2.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}2.csv");
	
  #driver 3 for instance 2
	#print  "start cmd /c ds35sqlserverdriver.exe --config_file=param3.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}3.csv\n"; 
    #system("start cmd /c ds35sqlserverdriver.exe --config_file=param3.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}3.csv");
	
#driver 4 for instance 2	
	#print  "start cmd /c ds35sqlserverdriver.exe --config_file=param4.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}4.csv\n"; 
    #system("start cmd /c ds35sqlserverdriver.exe --config_file=param4.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}4.csv");
	
  #driver 5 for instance 3
	#print  "start cmd /c ds35sqlserverdriver.exe --config_file=param5.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}5.csv\n"; 
    #system("start cmd /c ds35sqlserverdriver.exe --config_file=param5.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}5.csv");
	
#driver 6 for instance 3	
	#print  "start cmd /c ds35sqlserverdriver.exe --config_file=param6.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}6.csv\n"; 
    #system("start cmd /c ds35sqlserverdriver.exe --config_file=param6.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}6.csv");
	
  #driver 7 for instance 4
	#print  "start cmd /c ds35sqlserverdriver.exe --config_file=param7.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}7.csv\n"; 
    #system("start cmd /c ds35sqlserverdriver.exe --config_file=param7.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}7.csv");
		
	
  #driver 8 for instance 4
  print "ds35sqlserverdriver.exe --config_file=param2.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}${num_drivers}.csv --windows_perf_host=$ds3_target\n";
  `ds35sqlserverdriver.exe --config_file=param2.txt --n_threads=${threads_list[$i]} --out_filename=${threads_list[$i]}threads${title}${num_drivers}.csv --windows_perf_host=$ds3_target`;
