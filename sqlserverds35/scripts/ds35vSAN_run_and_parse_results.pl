...
my @paramfile_list = ("param5.txt","param6.txt","param7.txt","param8.txt","param1.txt","param2.txt","param3.txt","param4.txt");
my $num_ds3_targets = 4;
my @ds3_target_list = ("10.10.100.55","10.10.100.56","10.10.100.57","10.10.100.58","10.10.100.51","10.10.100.52","10.10.100.53","10.10.100.54");
my @esx_target_list = ("w2-bdperf2-001","w2-bdperf2-002","w2-bdperf2-003","w2-bdperf2-004");
my $intervals = 100;  # number of stats collection intervals 
my $delay = 15;      # time between each stats collection interval
